...
# Checking if widgets grid row is greater than or equal to 30, if condition is met, remove the widget from grid
    ...
    query_label = Label(root, text=print_records, bg = "sky blue", font = ("Arial black", 8, "bold"))
    query_label.grid(row=30, column=0, columnspan=4)
